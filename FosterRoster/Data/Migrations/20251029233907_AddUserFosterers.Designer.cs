...
namespace FosterRoster.Data.Migrations
{
    ...
    [Migration("20251029233907_AddUserFosterers")]
    partial class AddUserFosterers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserFosterers", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("UserId", "FostererId");

                    b.HasIndex("FostererId");

                    b.ToTable("UserFosterers");
                });
            ...
            modelBuilder.Entity("UserFosterers", b =>
                {
                    b.HasOne("FosterRoster.Features.Fosterers.Fosterer", null)
                        .WithMany()
                        .HasForeignKey("FostererId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
